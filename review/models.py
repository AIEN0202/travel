...
class Hotel(models.Model):
    ...
    style1 = models.CharField(max_length=200, blank=True, null=True)
    h_price1 = models.CharField(max_length=200, blank=True, null=True)
...
class Review(models.Model):
    ...
    contentofreview = models.CharField(db_column='ContentofReview', max_length=5000, blank=True, null=True)  # Field name made lowercase.
